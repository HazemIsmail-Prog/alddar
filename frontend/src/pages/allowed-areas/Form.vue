...
import type { AllowedArea, AllowedAreaForm } from '@/types'
        ...
        <SheetContent as="form" @submit.prevent="handleSubmitForm">
            ...
            <div class="grid flex-1 auto-rows-min gap-4 px-4">
                ...
                <Field>
                    ...
                    />
                    <FieldError :errors="formErrors.latitude" />
                </Field>
                <Field>
                    <FieldLabel for="longitude">
                        Longitude
                    </FieldLabel>
                    <Input
                        id="longitude"
                    ...
                    />
                    <FieldError :errors="formErrors.longitude" />
                </Field>
                <Field>
                    <FieldLabel for="radius">
                        Radius
                    </FieldLabel>
                    <Input
                        id="radius"
                        type="text"
                        v-model="form.radius"
                        :aria-invalid="formErrors.radius ? true : false"
                    />
                    <FieldError :errors="formErrors.radius" />
                </Field>
